...
<template>
  <div id="TopNav" class="sticky top-0 bg-[#121212] z-30 flex items-center w-full h-[61px] border-b border-[#ebebeb6c]">
    <div class="flex items-center justify-between container">
      <div>
        <NuxtLink to="/"> <img class="-ml-1" width="155" height="40" src="/public/tiktok-logo-white.png" /> </NuxtLink>
      </div>

      <div class="flex items-center justify-end gap-3 max-w-[250px] w-full">
        <button @click="isLoggedIn()" class="flex items-center transition bg-[#3a3a3a] rounded-md px-3 py-[6px] hover:bg-[#303030]">
        ...
        <div v-else class="flex items-center">
          ...
          <div class="relative">
            ...
            <Transition name="modal">
              <div v-if="showMenu" id="PopupMenu" class="absolute bg-[#3a3a3a] rounded-md w-[200px] shadow-xl top-[43px] -right-0">
                <NuxtLink
                ...
                <hr />
                <div @click="logout" class="flex items-center justify-start rounded-md py-3 px-2 hover:bg-[#303030] cursor-pointer">
